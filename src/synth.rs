...
impl Synth {
    ...
    pub fn bank_select(&self, chan: i32, bank: u32) -> bool {
        unsafe { fluid_synth_bank_select(self.c_fluid_synth, chan as c_int, bank as c_uint) == 0 }
    }
    ...
    pub fn sfreload(&self, id: u32) -> bool {
        unsafe { fluid_synth_sfreload(self.c_fluid_synth, id as c_uint) == 0 }
    }
    ...
    pub fn get_chorus_speed_hz(&self) -> f64 {
        unsafe { fluid_synth_get_chorus_speed_Hz(self.to_raw()) }
    }

    pub fn get_chorus_depth_ms(&self) -> f64 {
        unsafe { fluid_synth_get_chorus_depth_ms(self.to_raw()) }
    }
    ...
    pub fn select_tuning(&self, chan: i32, bank: i32, prog: i32) -> bool {
        unsafe {
            fluid_synth_select_tuning(self.to_raw(), chan as c_int, bank as c_int, prog as c_int)
                == 0
        }
    }
    ...
    pub fn reset_tuning(&self, chan: i32) -> bool {
        unsafe { fluid_synth_reset_tuning(self.to_raw(), chan as c_int) == 0 }
    }
    ...
    pub fn set_midi_router(&self, router: &MidiRouter) {
        unsafe { fluid_synth_set_midi_router(self.to_raw(), router.to_raw()) }
    }
