...
pub type fluid_audio_callback_t = ::std::option::Option<
    extern "C" fn(
        ...
        len: ::libc::c_int,
        out1: *mut ::libc::c_void,
        loff: ::libc::c_int,
        lincr: ::libc::c_int,
        out2: *mut ::libc::c_void,
        roff: ::libc::c_int,
        rincr: ::libc::c_int,
    ) -> ::libc::c_int,
>;
pub type fluid_cmd_func_t = ::std::option::Option<
    extern "C" fn(
...
impl ::std::default::Default for Struct_Unnamed2 {
    fn default() -> Struct_Unnamed2 {
        unsafe { ::std::mem::zeroed() }
    }
}
pub type fluid_cmd_t = Struct_Unnamed2;
pub type fluid_server_newclient_func_t = ::std::option::Option<
    extern "C" fn(data: *mut ::libc::c_void, addr: *mut ::libc::c_char) -> *mut fluid_cmd_handler_t,
>;
...
pub struct Struct__fluid_sfloader_t {
    pub data: *mut ::libc::c_void,
    pub free: ::std::option::Option<extern "C" fn(loader: *mut fluid_sfloader_t) -> ::libc::c_int>,
...
pub struct Struct__fluid_sfont_t {
    pub data: *mut ::libc::c_void,
    pub id: ::libc::c_uint,
    pub free: ::std::option::Option<extern "C" fn(sfont: *mut fluid_sfont_t) -> ::libc::c_int>,
    pub get_name:
        ::std::option::Option<extern "C" fn(sfont: *mut fluid_sfont_t) -> *mut ::libc::c_char>,
    ...
    >,
    pub iteration_start: ::std::option::Option<extern "C" fn(sfont: *mut fluid_sfont_t) -> ()>,
    pub iteration_next: ::std::option::Option<
        extern "C" fn(sfont: *mut fluid_sfont_t, preset: *mut fluid_preset_t) -> ::libc::c_int,
    >,
}
...
pub struct Struct__fluid_preset_t {
    ...
    pub free: ::std::option::Option<extern "C" fn(preset: *mut fluid_preset_t) -> ::libc::c_int>,
    pub get_name:
        ::std::option::Option<extern "C" fn(preset: *mut fluid_preset_t) -> *mut ::libc::c_char>,
    pub get_banknum:
        ::std::option::Option<extern "C" fn(preset: *mut fluid_preset_t) -> ::libc::c_int>,
    pub get_num: ::std::option::Option<extern "C" fn(preset: *mut fluid_preset_t) -> ::libc::c_int>,
...
pub struct Struct__fluid_sample_t {
    ...
    pub notify: ::std::option::Option<
        extern "C" fn(sample: *mut fluid_sample_t, reason: ::libc::c_int) -> ::libc::c_int,
    >,
...
pub type handle_midi_event_func_t = ::std::option::Option<
    extern "C" fn(data: *mut ::libc::c_void, event: *mut fluid_midi_event_t) -> ::libc::c_int,
>;
...
extern "C" {
    ...
    pub fn fluid_synth_get_channel_info(
        synth: *mut fluid_synth_t,
        chan: ::libc::c_int,
        info: *mut fluid_synth_channel_info_t,
    ) -> ::libc::c_int;
    pub fn fluid_synth_program_reset(synth: *mut fluid_synth_t) -> ::libc::c_int;
    pub fn fluid_synth_system_reset(synth: *mut fluid_synth_t) -> ::libc::c_int;
    ...
    pub fn fluid_synth_start(
        ...
        midi_chan: ::libc::c_int,
        key: ::libc::c_int,
        vel: ::libc::c_int,
    ) -> ::libc::c_int;
    pub fn fluid_synth_stop(synth: *mut fluid_synth_t, id: ::libc::c_uint) -> ::libc::c_int;
    pub fn fluid_synth_sfload(
        synth: *mut fluid_synth_t,
        filename: *const ::libc::c_char,
        reset_presets: ::libc::c_int,
    ) -> ::libc::c_int;
    pub fn fluid_synth_sfreload(synth: *mut fluid_synth_t, id: ::libc::c_uint) -> ::libc::c_int;
    ...
    pub fn fluid_synth_set_reverb_on(synth: *mut fluid_synth_t, on: ::libc::c_int) -> ();
    pub fn fluid_synth_get_reverb_roomsize(synth: *mut fluid_synth_t) -> ::libc::c_double;
    pub fn fluid_synth_get_reverb_damp(synth: *mut fluid_synth_t) -> ::libc::c_double;
    pub fn fluid_synth_get_reverb_level(synth: *mut fluid_synth_t) -> ::libc::c_double;
    pub fn fluid_synth_get_reverb_width(synth: *mut fluid_synth_t) -> ::libc::c_double;
    ...
    pub fn fluid_synth_set_chorus_on(synth: *mut fluid_synth_t, on: ::libc::c_int) -> ();
    pub fn fluid_synth_get_chorus_nr(synth: *mut fluid_synth_t) -> ::libc::c_int;
    pub fn fluid_synth_get_chorus_level(synth: *mut fluid_synth_t) -> ::libc::c_double;
    pub fn fluid_synth_get_chorus_speed_Hz(synth: *mut fluid_synth_t) -> ::libc::c_double;
    pub fn fluid_synth_get_chorus_depth_ms(synth: *mut fluid_synth_t) -> ::libc::c_double;
    pub fn fluid_synth_get_chorus_type(synth: *mut fluid_synth_t) -> ::libc::c_int;
    pub fn fluid_synth_count_midi_channels(synth: *mut fluid_synth_t) -> ::libc::c_int;
    pub fn fluid_synth_count_audio_channels(synth: *mut fluid_synth_t) -> ::libc::c_int;
    pub fn fluid_synth_count_audio_groups(synth: *mut fluid_synth_t) -> ::libc::c_int;
    pub fn fluid_synth_count_effects_channels(synth: *mut fluid_synth_t) -> ::libc::c_int;
    pub fn fluid_synth_set_sample_rate(
        synth: *mut fluid_synth_t,
        sample_rate: ::libc::c_float,
    ) -> ();
    pub fn fluid_synth_set_gain(synth: *mut fluid_synth_t, gain: ::libc::c_float) -> ();
    pub fn fluid_synth_get_gain(synth: *mut fluid_synth_t) -> ::libc::c_float;
    pub fn fluid_synth_set_polyphony(
        synth: *mut fluid_synth_t,
        polyphony: ::libc::c_int,
    ) -> ::libc::c_int;
    pub fn fluid_synth_get_polyphony(synth: *mut fluid_synth_t) -> ::libc::c_int;
    pub fn fluid_synth_get_active_voice_count(synth: *mut fluid_synth_t) -> ::libc::c_int;
    pub fn fluid_synth_get_internal_bufsize(synth: *mut fluid_synth_t) -> ::libc::c_int;
    ...
    pub fn fluid_synth_get_cpu_load(synth: *mut fluid_synth_t) -> ::libc::c_double;
    pub fn fluid_synth_error(synth: *mut fluid_synth_t) -> *mut ::libc::c_char;
    ...
    pub fn fluid_synth_set_midi_router(
        synth: *mut fluid_synth_t,
        router: *mut fluid_midi_router_t,
    ) -> ();
    pub fn fluid_get_stdin() -> fluid_istream_t;
    pub fn fluid_get_stdout() -> fluid_ostream_t;
    pub fn fluid_get_userconf(buf: *mut ::libc::c_char, len: ::libc::c_int) -> *mut ::libc::c_char;
    pub fn fluid_get_sysconf(buf: *mut ::libc::c_char, len: ::libc::c_int) -> *mut ::libc::c_char;
    pub fn new_fluid_cmd_handler(synth: *mut fluid_synth_t) -> *mut fluid_cmd_handler_t;
    ...
    pub fn fluid_cmd_handler_register(
        handler: *mut fluid_cmd_handler_t,
        cmd: *mut fluid_cmd_t,
    ) -> ::libc::c_int;
    pub fn fluid_cmd_handler_unregister(
        handler: *mut fluid_cmd_handler_t,
    ...
    pub fn delete_fluid_ramsample(sample: *mut fluid_sample_t) -> ::libc::c_int;
    ...
    pub fn fluid_file_renderer_process_block(dev: *mut fluid_file_renderer_t) -> ::libc::c_int;
    ...
    pub fn fluid_event_set_source(evt: *mut fluid_event_t, src: ::libc::c_short) -> ();
    pub fn fluid_event_set_dest(evt: *mut fluid_event_t, dest: ::libc::c_short) -> ();
    pub fn fluid_event_timer(evt: *mut fluid_event_t, data: *mut ::libc::c_void) -> ();
    ...
    pub fn fluid_event_all_sounds_off(evt: *mut fluid_event_t, channel: ::libc::c_int) -> ();
    pub fn fluid_event_all_notes_off(evt: *mut fluid_event_t, channel: ::libc::c_int) -> ();
    ...
    pub fn fluid_event_any_control_change(evt: *mut fluid_event_t, channel: ::libc::c_int) -> ();
    ...
    pub fn fluid_event_get_velocity(evt: *mut fluid_event_t) -> ::libc::c_short;
    pub fn fluid_event_get_control(evt: *mut fluid_event_t) -> ::libc::c_short;
    pub fn fluid_event_get_value(evt: *mut fluid_event_t) -> ::libc::c_short;
    pub fn fluid_event_get_program(evt: *mut fluid_event_t) -> ::libc::c_short;
    pub fn fluid_event_get_data(evt: *mut fluid_event_t) -> *mut ::libc::c_void;
    pub fn fluid_event_get_duration(evt: *mut fluid_event_t) -> ::libc::c_uint;
    ...
    pub fn fluid_event_get_sfont_id(evt: *mut fluid_event_t) -> ::libc::c_uint;
    pub fn new_fluid_midi_event() -> *mut fluid_midi_event_t;
    pub fn delete_fluid_midi_event(event: *mut fluid_midi_event_t) -> ::libc::c_int;
    pub fn fluid_midi_event_set_type(
        evt: *mut fluid_midi_event_t,
        _type: ::libc::c_int,
    ) -> ::libc::c_int;
    pub fn fluid_midi_event_get_type(evt: *mut fluid_midi_event_t) -> ::libc::c_int;
    pub fn fluid_midi_event_set_channel(
        evt: *mut fluid_midi_event_t,
        chan: ::libc::c_int,
    ) -> ::libc::c_int;
    pub fn fluid_midi_event_get_channel(evt: *mut fluid_midi_event_t) -> ::libc::c_int;
    pub fn fluid_midi_event_get_key(evt: *mut fluid_midi_event_t) -> ::libc::c_int;
    pub fn fluid_midi_event_set_key(
        evt: *mut fluid_midi_event_t,
        key: ::libc::c_int,
    ) -> ::libc::c_int;
    pub fn fluid_midi_event_get_velocity(evt: *mut fluid_midi_event_t) -> ::libc::c_int;
    pub fn fluid_midi_event_set_velocity(
        evt: *mut fluid_midi_event_t,
        vel: ::libc::c_int,
    ) -> ::libc::c_int;
    pub fn fluid_midi_event_get_control(evt: *mut fluid_midi_event_t) -> ::libc::c_int;
    pub fn fluid_midi_event_set_control(
        evt: *mut fluid_midi_event_t,
        ctrl: ::libc::c_int,
    ) -> ::libc::c_int;
    pub fn fluid_midi_event_get_value(evt: *mut fluid_midi_event_t) -> ::libc::c_int;
    pub fn fluid_midi_event_set_value(
        evt: *mut fluid_midi_event_t,
        val: ::libc::c_int,
    ) -> ::libc::c_int;
    pub fn fluid_midi_event_get_program(evt: *mut fluid_midi_event_t) -> ::libc::c_int;
    pub fn fluid_midi_event_set_program(
        evt: *mut fluid_midi_event_t,
        val: ::libc::c_int,
    ) -> ::libc::c_int;
    pub fn fluid_midi_event_get_pitch(evt: *mut fluid_midi_event_t) -> ::libc::c_int;
    ...
    pub fn delete_fluid_midi_router(handler: *mut fluid_midi_router_t) -> ::libc::c_int;
    pub fn fluid_midi_router_set_default_rules(router: *mut fluid_midi_router_t) -> ::libc::c_int;
    pub fn fluid_midi_router_clear_rules(router: *mut fluid_midi_router_t) -> ::libc::c_int;
    ...
    pub fn fluid_player_set_bpm(player: *mut fluid_player_t, bpm: ::libc::c_int) -> ::libc::c_int;
    pub fn fluid_player_get_status(player: *mut fluid_player_t) -> ::libc::c_int;
    ...
    pub fn new_fluid_sequencer2(use_system_timer: ::libc::c_int) -> *mut fluid_sequencer_t;
    pub fn delete_fluid_sequencer(seq: *mut fluid_sequencer_t) -> ();
    pub fn fluid_sequencer_get_use_system_timer(seq: *mut fluid_sequencer_t) -> ::libc::c_int;
    ...
    pub fn fluid_sequencer_unregister_client(
        seq: *mut fluid_sequencer_t,
        id: ::libc::c_short,
    ) -> ();
    pub fn fluid_sequencer_count_clients(seq: *mut fluid_sequencer_t) -> ::libc::c_int;
    ...
    pub fn fluid_sequencer_process(seq: *mut fluid_sequencer_t, msec: ::libc::c_uint) -> ();
    ...
    pub fn fluid_sequencer_get_tick(seq: *mut fluid_sequencer_t) -> ::libc::c_uint;
    pub fn fluid_sequencer_set_time_scale(
        seq: *mut fluid_sequencer_t,
        scale: ::libc::c_double,
    ) -> ();
    pub fn fluid_sequencer_get_time_scale(seq: *mut fluid_sequencer_t) -> ::libc::c_double;
    ...
    pub fn fluid_log(level: ::libc::c_int, fmt: *const ::libc::c_char, ...) -> ::libc::c_int;
    pub fn fluid_is_soundfont(filename: *const ::libc::c_char) -> ::libc::c_int;
    pub fn fluid_is_midifile(filename: *const ::libc::c_char) -> ::libc::c_int;
    pub fn fluid_mod_new() -> *mut fluid_mod_t;
    pub fn fluid_mod_delete(_mod: *mut fluid_mod_t) -> ();
    pub fn fluid_mod_set_source1(
        _mod: *mut fluid_mod_t,
        src: ::libc::c_int,
        flags: ::libc::c_int,
    ) -> ();
    ...
    pub fn fluid_mod_set_amount(_mod: *mut fluid_mod_t, amount: ::libc::c_double) -> ();
    ...
    pub fn fluid_mod_test_identity(mod1: *mut fluid_mod_t, mod2: *mut fluid_mod_t)
        -> ::libc::c_int;
    pub fn fluid_gen_set_default_values(gen: *mut fluid_gen_t) -> ::libc::c_int;
    pub fn fluid_voice_update_param(voice: *mut fluid_voice_t, gen: ::libc::c_int) -> ();
    pub fn fluid_voice_add_mod(
        voice: *mut fluid_voice_t,
        _mod: *mut fluid_mod_t,
        mode: ::libc::c_int,
    ) -> ();
    pub fn fluid_voice_gen_set(
        voice: *mut fluid_voice_t,
        gen: ::libc::c_int,
        val: ::libc::c_float,
    ) -> ();
    pub fn fluid_voice_gen_get(voice: *mut fluid_voice_t, gen: ::libc::c_int) -> ::libc::c_float;
    pub fn fluid_voice_gen_incr(
        voice: *mut fluid_voice_t,
        gen: ::libc::c_int,
        val: ::libc::c_float,
    ) -> ();
    ...
    pub fn fluid_voice_optimize_sample(s: *mut fluid_sample_t) -> ::libc::c_int;
